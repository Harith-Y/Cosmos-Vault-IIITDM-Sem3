//Aim: to pack maximum objects as possible
#include<string>
#include<cstring>
#include<iostream>
#include<fstream>
...
int main()
{
    ...
    inputFile.close();
                                           ...
                                           //first index represents profits & second index represents weights 
 for(int i=0; i<n; i++) //bubble sort implementation
 {
  for(int j=0; j<n-i-1; j++)
  {
   if(objects[j][1]>objects[j+1][1])
   {
