...
class Matrix {
    ...
    public: Matrix& operator++(); // Prefix increment: ++A
    public: Matrix operator++(int); // Postfix increment: A++
    public: Matrix& operator--(); // Prefix decrement: --A
    public: Matrix operator--(int); // Postfix decrement: A--
